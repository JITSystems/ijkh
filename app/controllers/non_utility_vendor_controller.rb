	...
	def create
		...
		if params[:picture]
			map_name = @non_utility_vendor.id
		  	...
		  	directory = File.join('..','shared','public','images','non_utility_maps', @non_utility_vendor.non_utility_service_type_id.to_s)
		  	...
		  	directory = File.join('..','shared','images','non_utility_maps', @non_utility_vendor.non_utility_service_type_id.to_s)
		  	path = File.join(directory, name)
		  	path
